								...
								@foreach ($reservations as $reservation)
									<tr>
										...
										<td>
											...
											document.getElementById('food-category-{{$reservation->id}}').submit();">
											<i class="far fa-trash-alt"></i>
											</a>
											<form id="food-category-{{$reservation->id}}" action="/admin/reservations/{{$reservation->id}}/delete" method="POST">
												@method('DELETE')
												@csrf
											</form>
										</td>
