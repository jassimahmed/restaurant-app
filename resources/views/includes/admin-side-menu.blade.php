							...
							<li class="nav-item">
								...
								<div id="submenu-4-1" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item">
											<a class="nav-link" href="/admin/reservations/create">New Reservation</a>
										</li>
									</ul>
								</div>
							</li>
				...
				<li class="nav-item">
					...
					<div id="submenu-5" class="collapse submenu" style="">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link" href="/admin/settings/ceo">CEO<span class="badge badge-secondary">New</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="/admin/settings/social-accounts">Social Accounts<span class="badge badge-secondary">New</span></a>
							</li>
						</ul>
					</div>
				</li>
